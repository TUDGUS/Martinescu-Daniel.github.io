...
bool mark_yellow(PlayerSheet* sheet, int value, int roll_number, bool is_active_player) {
    ...
    if ((row==0 || row==1) && sheet->yellow_area[0][value-1] && sheet->yellow_area[1][value-1]) {
        ...
        switch(bonus_col) {
            ...
            case 2: sheet->pending_bonus_type = BONUS_PINK; break;
            case 3: sheet->actions.extra_die_charges++; break;
            case 4: sheet->pending_bonus_type = BONUS_TURQUOISE; break;
    ...
    if ((row==1 || row==2) && sheet->yellow_area[1][value-1] && sheet->yellow_area[2][value-1]) {
        ...
        switch(bonus_col) {
            ...
            case 1: sheet->pending_bonus_type = BONUS_TURQUOISE; break;
            case 2: sheet->pending_bonus_type = BONUS_BLUE; break;
            case 3: sheet->pending_bonus_type = BONUS_BROWN; break;
            case 4: sheet->pending_bonus_type = BONUS_YELLOW; break;
...
void activate_turquoise_bonus(PlayerSheet* sheet, int index, bool is_column) {
    if (is_column) {
        switch(index) {
            case 0: sheet->pending_bonus_type = BONUS_BROWN; break;
            case 1: sheet->pending_bonus_type = BONUS_PINK; break;
            case 2: sheet->pending_bonus_type = BONUS_YELLOW; break;
            case 3: sheet->actions.any_number_charges++; break;
            case 4: sheet->pending_bonus_type = BONUS_BLUE; break;
        ...
        switch(index) {
            ...
            case 2: sheet->pending_bonus_type = BONUS_BROWN; break;
            case 3: sheet->pending_bonus_type = BONUS_TURQUOISE; break;
            case 4: break;
        }
    }
}
...
void handle_turquoise_pick(GameState* game, PlayerSheet* sheet, int die_index, bool is_active_player) {
    // Legacy stub - turquoise picking is handled by UIMODE_ACTIVE_TURQUOISE in ui.c
    (void)game; (void)sheet; (void)die_index; (void)is_active_player;
}
...
void check_and_activate_blue_bonus(PlayerSheet* sheet, int position) {
    ...
    switch(position) {
        ...
        case 1: sheet->pending_bonus_type = BONUS_PINK; break;
        case 3: sheet->pending_bonus_type = BONUS_YELLOW; break;
        case 4: sheet->actions.any_number_charges++; break;
        case 8: sheet->actions.reroll_charges++; break;
        case 9: sheet->pending_bonus_type = BONUS_BROWN; break;
        case 11: sheet->pending_bonus_type = BONUS_TURQUOISE; break;
...
bool mark_blue_seven(PlayerSheet* sheet) {
    // Handled by UIMODE_BLUE_SEVEN in ui.c - this stub exists for compatibility
    return false;
}
...
void activate_brown_bonus(PlayerSheet* sheet, int bonus_index) {
    ...
    switch(bonus_index) {
        ...
        case 7: sheet->pending_bonus_type = BONUS_BLUE; break;
        case 8: break;
        case 9: sheet->pending_bonus_type = BONUS_YELLOW; break;
...
void activate_pink_bonus(PlayerSheet* sheet, int position) {
    ...
    switch(position) {
        ...
        case 3: sheet->actions.extra_die_charges++; break;
        case 4: sheet->actions.any_number_charges++; break;
        case 5: sheet->pending_bonus_type = BONUS_YELLOW; break;
        case 6: sheet->pending_bonus_type = BONUS_BROWN; break;
        case 7: sheet->actions.reroll_charges++; break;
        case 8: sheet->actions.foxes_unlocked++; break;
        case 9: sheet->pending_bonus_type = BONUS_BLUE; break;
        case 10: sheet->pending_bonus_type = BONUS_TURQUOISE; break;
        case 11: sheet->pending_bonus_type = BONUS_YELLOW; break; // white ? - UI handles via BONUS_CHOOSE_COLOR
    }
